        ...
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="https://www.shop.coffeehabesha.com/shop-coffee-habesha/" className="text-muted-foreground hover:text-primary transition-colors" target="_blank" rel="noopener noreferrer">Shop</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="https://www.shop.coffeehabesha.com/shop-coffee-habesha/" className="text-muted-foreground hover:text-primary transition-colors" target="_blank" rel="noopener noreferrer">Shop All Coffees</a></li>
          ...
          <div>
            ...
            <div className="mt-4 space-y-2">
              <a href="https://www.shop.coffeehabesha.com/my-account/" target="_blank" rel="noopener noreferrer" className="block text-muted-foreground hover:text-primary transition-colors">My Account</a>
              <a href="https://www.shop.coffeehabesha.com/my-account/orders/" target="_blank" rel="noopener noreferrer" className="block text-muted-foreground hover:text-primary transition-colors">Order History</a>
            </div>
          </div>
        </div>
